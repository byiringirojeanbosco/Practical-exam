...
export default function FollowUpPage() {
  ...
  const { state, setReminder, completeVisit, resetFlow, t } = useAppointment();
  ...
  return (
    <div className="space-y-5">
      <section className="space-y-2">
        <Badge tone="blue">{t("follow.step")}</Badge>
        <h2 className="text-2xl font-bold text-gray-900">{t("follow.title")}</h2>
        <p className="text-sm leading-6 text-gray-600">{t("follow.subtitle")}</p>
      </section>

      <Card>
        <div className="flex flex-wrap items-center gap-2">
          <Badge tone="green">{t("follow.complete")}</Badge>
      ...
      <Card>
        <h3 className="text-base font-bold text-gray-900">{t("follow.prescription")}</h3>
      ...
      <Card>
        <h3 className="text-base font-bold text-gray-900">{t("follow.followUp")}</h3>
      ...
      <Card>
        <h3 className="text-base font-bold text-gray-900">{t("follow.settings")}</h3>
        <div className="mt-4 grid gap-3">
          <ToggleRow
            title={t("follow.medTitle")}
            description={t("follow.medDesc")}
            checked={reminders.medication}
            onChange={(enabled) => setReminder("medication", enabled)}
          />
          <ToggleRow
            title={t("follow.followUp")}
            description={t("follow.followDesc")}
