          ...
          <div className="flex min-w-max gap-2">
            {steps.map((step, index) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  [
                    "focus-ring subtle-transition flex min-h-10 items-center rounded-full border px-3 text-sm font-semibold",
                    isActive
              ...
              >
                <span className="mr-2 flex h-5 w-5 items-center justify-center rounded-full bg-white/20 text-xs">
                  {index + 1}
                </span>
                {step.label}
              </NavLink>
